...
export default function DonorManagement({ donors, onUpdate }: DonorManagementProps) {
  ...
  const handleAddDonor = async (formData: FormData) => {
    ...
    try {
      ...
      await mockApi.createDonor(newDonor);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-gray-900">Donor Management</h2>
          <p className="text-gray-600">Register and manage organ and blood donors</p>
        </div>
        ...
        <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={(e) => {
              ...
              <div>
                <Label>Available Organs/Tissues</Label>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Available Organs</TableHead>
                ...
                <TableRow key={donor.id}>
                  ...
                  <TableCell>
                    <div className="flex flex-wrap gap-1">
                      {donor.availableOrgans.slice(0, 2).map(organ => (
                        <Badge key={organ} variant="secondary" className="text-xs">
                          {organ}
                        </Badge>
                      ))}
                      {donor.availableOrgans.length > 2 && (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  {selectedDonor.availableOrgans.map(organ => (

...
export default function MatchingEngine({ recipients }: MatchingEngineProps) {
  ...
  const handleFindMatches = async () => {
    ...
    try {
      const foundMatches = await mockApi.findMatches(selectedRecipient);
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select a recipient to find the best matching donors based on blood type, organ compatibility, and proximity
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {selectedRecipientData.neededOrgans.map(organ => (
